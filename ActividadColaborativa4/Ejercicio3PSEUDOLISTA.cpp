...
int main() {
    ...
    cout << "PRIMERA vuelta a la lista: " << endl;
    reccorreLista(lista);

    Nodo<int> *nodoNuevo = new Nodo(43);
    insertarCabeza(nodoNuevo,lista);

    cout << "SEGUNDA vuelta a la lista - ELEMENTO AÑADIDO EN LA CABEZA " << endl;
    reccorreLista(lista);

    Nodo<int> *nodoNuevoFinal = new Nodo(24);
    insertarCola(nodoNuevoFinal,lista);

    cout << "TERCERA vuelta a la lista - ELEMENTO AÑADIDO EN LA COLA " << endl;
    reccorreLista(lista);

    Nodo<int> *nodoNuevoIntermedio = new Nodo(55);
    insertarPosicion(nodoNuevoIntermedio,lista,1);

    cout << "CUARTA vuelta a la lista - ELEMENTO AÑADIDO EN LA TERCERA POSICIÓN " << endl;
    reccorreLista(lista);
